    ...
    internal class SAMOpenerLogic : SAM
    {
        ...
        private bool DoOpener(ref uint actionID)
        {
            ...
            if (currentState == OpenerState.InOpener)
            {
                ...
                if (CustomComboFunctions.WasLastAction(MidareSetsugekka) && OpenerStep == 5) OpenerStep++;
                else if (OpenerStep == 5) actionID = MidareSetsugekka;
                ...
                if (CustomComboFunctions.WasLastAction(MidareSetsugekka) && OpenerStep == 23) OpenerStep++;
                else if (OpenerStep == 23) actionID = MidareSetsugekka;
